...
@Table(name = "overseas_stock_static_analysis", indexes = {
        @Index(name = "idx_overseas_static_stock_code", columnList = "stockCode")
})
public class OverseasStockStaticAnalysis {
