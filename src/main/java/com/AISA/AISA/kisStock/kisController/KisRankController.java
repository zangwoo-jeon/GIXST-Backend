...
public class KisRankController {
        ...
        @GetMapping("/investor")
        @Operation(summary = "투자자별 수급 랭킹 조회", description = "최근 1일/1주/1개월/3개월/6개월간 개인/외국인/기관 투자자별 순매수/순매도 랭킹을 조회합니다. "
                        + "(period: 1d, 1w, 1m, 3m, 6m / type: personal_buy, personal_sell, foreigner_buy, foreigner_sell, institution_buy, institution_sell)")
