...
class OverseasQualityAnalysisServiceTest {
        ...
        void testCalculateQualityAnalysis_V4_ROIC() {
                ...
                when(financialRatioRepository.findTop1ByStockCodeAndDivCodeOrderByStacYymmDesc(anyString(),
                                anyString()))
                ...
                when(financialStatementRepository.findTop5ByStockCodeAndDivCodeOrderByStacYymmDesc(anyString(),
                                anyString()))
                ...
                assertTrue(response.getQualityAnalysis().getMetrics().getRoicVsWacc().contains("11.6"));
        }
}
